...
Twenty-two catalog themes live in [`references/tokens.css`](references/tokens.css). Four verbs cover greenfield builds, audits, redesigns, and design DNA extraction.
