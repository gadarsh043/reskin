...
`audit-report.md` — the kind of output Reskin produces in a real session. It can be saved to a PR, pasted into a Linear ticket, or used as the brief for the follow-up `redesign` run.
