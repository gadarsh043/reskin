# `reskin audit input.html`

> User invocation: *"reskin audit input.html"*
...
Do **not** run `reskin refine` here. Run `reskin redesign` instead — `refine` preserves structure, and the structure itself is the primary problem. See [`../redesign/`](../redesign/) for what a redesign of a similar page looks like.
